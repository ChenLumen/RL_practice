...
class TrulyPPO():
    ...
    def compute_loss(self, action_mean, action_std, old_action_mean, old_action_std, values, old_values, next_values,
...
class Agent():
    ...
    def training_ppo(self, states, actions, rewards, dones, next_states):
        ...
        loss = self.policy_loss.compute_loss(action_mean, self.std, old_action_mean, self.std, values, old_values,
